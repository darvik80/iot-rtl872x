...
#ifdef CONFIG_GHD_EN
#include <example_game_headset_dongle.h>
#endif

#ifdef CONFIG_GHH_EN
#include <example_game_headset.h>
#endif
...
#if defined(CONFIG_EXAMPLE_RTSP_CLIENT) && CONFIG_EXAMPLE_RTSP_CLIENT
#include <rtsp_client/example_rtsp_client.h>
#endif
...
#include <usbd_composite/example_usbd_composite.h>
#endif

#if defined(CONFIG_EXAMPLE_USBD_HID) && CONFIG_EXAMPLE_USBD_HID
#include <usbd_hid/example_usbd_hid.h>
#endif
...
#if defined(CONFIG_EXAMPLE_USBD_AUDIO_OLD) && CONFIG_EXAMPLE_USBD_AUDIO_OLD
#include <usbd_audio_old/example_usbd_audio_old.h>
#endif

#if defined(CONFIG_EXAMPLE_USBD_CDC_ACM_OLD) && CONFIG_EXAMPLE_USBD_CDC_ACM_OLD
#include <usbd_cdc_acm_old/example_usbd_cdc_acm_old.h>
#endif

#if defined(CONFIG_EXAMPLE_USBD_HID_OLD) && CONFIG_EXAMPLE_USBD_HID_OLD
#include <usbd_hid_old/example_usbd_hid_old.h>
#endif

#if defined(CONFIG_EXAMPLE_USBD_MSC_OLD) && CONFIG_EXAMPLE_USBD_MSC_OLD
#include <usbd_msc_old/example_usbd_msc_old.h>
#endif

#if defined(CONFIG_EXAMPLE_USBD_VENDOR_OLD) && CONFIG_EXAMPLE_USBD_VENDOR_OLD
#include <usbd_vendor_old/example_usbd_vendor_old.h>
#endif
...
#if defined(CONFIG_EXAMPLE_USBH_CDC_ACM_OLD) && CONFIG_EXAMPLE_USBH_CDC_ACM_OLD
#include <usbh_cdc_acm_old/example_usbh_cdc_acm_old.h>
#endif

#if defined(CONFIG_EXAMPLE_USBH_MSC_OLD) && CONFIG_EXAMPLE_USBH_MSC_OLD
#include <usbh_msc_old/example_usbh_msc_old.h>
#endif

#if defined(CONFIG_EXAMPLE_USBH_UVC_OLD) && CONFIG_EXAMPLE_USBH_UVC_OLD
#include <usbh_uvc_old/example_usbh_uvc_old.h>
#endif

#if defined(CONFIG_EXAMPLE_USBH_VENDOR_OLD) && CONFIG_EXAMPLE_USBH_VENDOR_OLD
#include <usbh_vendor_old/example_usbh_vendor_old.h>
#endif
...
#if defined(CONFIG_EXAMPLE_HTTPD_LITTLEFS) && CONFIG_EXAMPLE_HTTPD_LITTLEFS
	example_httpd_littlefs();
#endif

#if defined(CONFIG_EXAMPLE_SPI_NAND_LITTLEFS) && CONFIG_EXAMPLE_SPI_NAND_LITTLEFS
	example_spi_nand_littlefs();
#endif
